...
We will further use a slightly different approach and investigate the frequency of all mutations relative to the reference allele and visualize a histogram based on the frequencies of reads carrying different mutations. We will therefore construct a so-called mpileup file for the 2L region and use a custom script to count mutations and their frequencies. Then, we summarize the frequency and patterns of mutations in the 2L region across all libraries and visualize the results in R.
...
## count the frequency of reads carrying alternative alleles at each position
...
Next we will visualize the number of mutations for each library. Then we will make histograms that depict the frequency of reads carrying a given mutation for each library.
...
![Barplot Mutations](results/MutationFreq/2L_mutation_frequency.png)

#### 18DZ5 (historic)

![Frequency Histogram 18DZ5](results/MutationFreq/2L_mutation_frequency_histogram_18DZ5.png)

#### DGRP338 (recent)

![Frequency Histogram DGRP338](results/MutationFreq/2L_mutation_frequency_histogram_DGRP338.png)
